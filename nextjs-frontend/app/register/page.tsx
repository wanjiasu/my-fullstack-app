      ...
      <div className="relative w-full max-w-md">
        ...
        <form action={dispatch} className="glass rounded-2xl shadow-soft p-8">
          ...
          <div className="space-y-6">
            ...
            {/* Features highlight */}
            <div className="rounded-xl border border-indigo-400/20 p-4 mt-6" style={{ background: "rgba(99,102,241,.08)" }}>
        ...
        <div className="text-center mt-8">
          <p className="text-xs text-white/40">
            注册即表示您同意我们的{" "}
            <Link href="#" className="underline hover:text-white/60">服务条款</Link>{" "}
            和{" "}
            <Link href="#" className="underline hover:text-white/60">隐私政策</Link>
          </p>
        </div>
      </div>
    </div>
